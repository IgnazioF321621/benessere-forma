...
**Sul fronte GIF**: **Mobilità**, l'ultima zona, ~215 file mai entrati nel bucket — e per regola entrano già ridotti a 480 px. Lista completa in [`docs/CANTIERI.md`](docs/CANTIERI.md).
