...
*Generato da `tools/biblioteca-nomi/stato.py` il 2026-08-31 alle 16:28.* Sola lettura: nessuna modifica a database, Storage o Sheet.
...
|---|---|---|
| Righe totali | 707 |  |
| Ultimo sync | 2026-08-31 14:20 | istante in cui il foglio ha riscritto le righe |
