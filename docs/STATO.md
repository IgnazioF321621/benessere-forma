...
*Generato da `tools/biblioteca-nomi/stato.py` il 2026-08-21 alle 15:47.* Sola lettura: nessuna modifica a database, Storage o Sheet.
...
|---|---|---|
| Righe totali | 665 |  |
| Ultimo sync | 2026-08-21 13:45 | istante in cui il foglio ha riscritto le righe |
| Righe arenate | 0 | nessuna: foglio e database allineati |
| Prossimo codice libero | EX677 | da allocare al momento della scrittura, mai in anticipo |
| Codici con GIF | 600 |  |
...
**Per livello**: (vuoto) 2 · avanzato 54 · intermedio 256 · intermedio;avanzato 38 · principiante 161 · principiante;intermedio 129 · principiante;intermedio;avanzato 25
...
|---|---|---|
| **Viva** | 600 | un codice la punta e il file c'è — è ciò che l'app mostra |
| **Rotta** | 0 | un codice la punta ma il file non c'è — **l'app mostra `missing`** |
| **Libera** | 67 | la GIF c'è ma nessun codice la usa — cantiere 16 |
