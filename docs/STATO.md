...
*Generato da `tools/biblioteca-nomi/stato.py` il 2026-08-31 alle 15:34.* Sola lettura: nessuna modifica a database, Storage o Sheet.
...
|---|---|---|
| Righe totali | 707 |  |
| Ultimo sync | 2026-08-27 20:35 | istante in cui il foglio ha riscritto le righe |
...
| **Libera** | 41 | la GIF c'è ma nessun codice la usa — cantiere 16 |
