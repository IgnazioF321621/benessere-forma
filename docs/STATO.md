...
*Generato da `tools/biblioteca-nomi/stato.py` il 2026-08-24 alle 17:19.* Sola lettura: nessuna modifica a database, Storage o Sheet.
...
|---|---|---|
| Righe totali | 703 |  |
| Ultimo sync | 2026-08-24 15:09 | istante in cui il foglio ha riscritto le righe |
...
| **Libera** | 27 | la GIF c'è ma nessun codice la usa — cantiere 16 |
