...
*Generato da `tools/biblioteca-nomi/stato.py` il 2026-08-21 alle 08:55.* Sola lettura: nessuna modifica a database, Storage o Sheet.
...
|---|---|---|
| Righe totali | 664 |  |
| Ultimo sync | 2026-08-21 06:49 | istante in cui il foglio ha riscritto le righe |
...
**Per uso**: accessorio 72 · accessorio;finisher 18 · accessorio;riscaldamento 5 · accessorio;riscaldamento;attivazione 1 · carry 2 · carry;finisher 2 · finisher 33 · finisher;recupero 1 · isolamento 16 · principale 316 · principale;accessorio 6 · principale;finisher 134 · principale;finisher;recupero 3 · principale;recupero 2 · principale;riscaldamento 16 · recupero 3 · recupero;mobilita 7 · riscaldamento 18 · riscaldamento;attivazione 3 · riscaldamento;finisher 2 · skill 4

**Per livello**: (vuoto) 2 · avanzato 54 · intermedio 256 · intermedio;avanzato 38 · principiante 160 · principiante;intermedio 129 · principiante;intermedio;avanzato 25
...
|---|---|---|
| **Viva** | 599 | un codice la punta e il file c'è — è ciò che l'app mostra |
| **Rotta** | 0 | un codice la punta ma il file non c'è — **l'app mostra `missing`** |
| **Libera** | 68 | la GIF c'è ma nessun codice la usa — cantiere 16 |
